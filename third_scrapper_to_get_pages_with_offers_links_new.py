...
def get_next_page_with_links():
    ...
    url = 'https://www.travelplanet.pl/wczasy/oferty/?kierunek=14:&wylot=26.04.2019&przylot=30.09.2019&osoby=2&dzieci=2&czas=6:8&wyzywienie=1&dojazd=F&sortowanie=1&kolejnosc=up&limit=75'
    for i in range(3):
        ...
        # Get next page url
        next_page_url = selector.css('#pagination--top > a:nth-child(7)::attr(href)').get()
        print(next_page_url)
...
with open('stored_links2.json', 'w', encoding="utf-8") as stored_links:
